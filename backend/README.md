...
## Project Structure
    ...
    ├── testapiautoconnecto_88380  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_88380`
...
2. Clone this repo and `cd testapiautoconnecto_88380`
